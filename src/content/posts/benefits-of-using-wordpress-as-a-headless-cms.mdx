...
description: "The Benefits of Using WordPress as a Headless CMS"
category: "WordPress"
...
In a headless WordPress setup, the back-end content management system is separated from the front-end delivery system. This separation can [improve performance](https://shameem.me/rocket-hosting-is-it-the-best-wordpress-hosting/), as the back-end, CMS can focus solely on content management. In contrast, the front-end application can focus exclusively on delivering content to users.
