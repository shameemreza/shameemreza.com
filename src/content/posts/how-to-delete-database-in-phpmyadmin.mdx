...
featuredImage: "../../assets/uploads/how-to-delete-database-in-phpmyadmin.jpg"
draft: false
---
...
![phpMyAdmin dashboard on localhost](../../assets/uploads/phpmyadmin-1-1024x447.png)

Click **Databases** in the top menu to see the list of every database on the server.

![List of databases in phpMyAdmin](../../assets/uploads/phpmyadmin-db-list-1-1024x789.png)
...
![Dropping a database from the Databases list](../../assets/uploads/phpmyadmin-delete-db-1024x680.png)
...
![Dropping a database from the Operations tab](../../assets/uploads/different-way-to-delete-1-1024x511.png)

![Confirmation prompt before dropping the database](../../assets/uploads/final-db-delete.png)
...
![Database with tables listed](../../assets/uploads/database-list-1.png)

To drop one table, click the red **Drop** button next to it.

![Drop button next to a single table](../../assets/uploads/delete-table-in-database-1024x571.png)
...
![Bulk drop from the With selected dropdown](../../assets/uploads/database-drop-1-1024x414.png)
