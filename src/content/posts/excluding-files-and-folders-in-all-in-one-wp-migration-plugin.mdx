...
description: "Large backups slow down migration. Here's how to exclude specific folders from All-in-One WP Migration exports using a code snippet or a free plugin."
category: "WordPress"
...
Such as, If you face Uploading size limit issues using the All In One WP Migration plugin's free version, you can follow my other post on it where I shared how to resolve the [All In One WP Migration plugins uploads limit problem](/increase-upload-limit-for-all-in-one-wp-migration-plugin/).
...
[![](/uploads/Folder-Excluder-for-AIO-WP-Migration-1024x456.png)](/excluding-files-and-folders-in-all-in-one-wp-migration-plugin/folder-excluder-for-aio-wp-migration/#main)
...
[![](/uploads/AIO-WP-Migration-Folder-Excluder-setting-1024x765.png)](/excluding-files-and-folders-in-all-in-one-wp-migration-plugin/aio-wp-migration-folder-excluder-setting/#main)

Upon opening AIO WP Migration Folder Excluder options, you will see all the configurations available, which is quite simple. You have to add the [relative path of the folders](/fix-upload-path-error-in-wordpress/) under wp-content that you want to exclude; you** **can separate the paths with a comma.

[![](/uploads/AIO-WP-Migration-Folder-Excluder-1024x472.png)](/excluding-files-and-folders-in-all-in-one-wp-migration-plugin/aio-wp-migration-folder-excluder/#main)

When saving, you will see that all the folder paths to exclude will appear in the lower section.

[![](/uploads/AIO-WP-Migration-Folder-Excluder-screen-1024x622.png)](/excluding-files-and-folders-in-all-in-one-wp-migration-plugin/aio-wp-migration-folder-excluder-screen/#main)
