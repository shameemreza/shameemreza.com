...
And yes, know what? You successfully implemented geo location in your [flutter project](/how-to-connect-flutter-app-to-websocket-server/).
...
If you still find it a bit confusing about Flutter Geolocator, do [reach out to me](/contact) on [Twitter](https://twitter.com/shameemdev) or add your comment in the comment box below.
