...
Now that we know what forwardRef and useRef are, let's see how we can use them to expose component functions. In this example, we will create a custom input [react component](https://shameem.me/render-an-array-of-objects-in-react/) that will be used to validate the user's input. We will expose the input's value and isValid functions using forwardRef and useRef.

https://gist.github.com/shameemreza/74b371fbb9d716fba7817684186efc39
...
https://gist.github.com/shameemreza/1e05d6e694ce5e4b0d11c421569020b2
