...
description: "forwardRef and useRef let you call a child component's methods from the parent. Here's a practical example using a custom input with validation."
