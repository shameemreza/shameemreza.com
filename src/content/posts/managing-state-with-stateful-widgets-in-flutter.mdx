...
If you wan to manage the state of your [flutter application](/how-to-connect-flutter-app-to-websocket-server/), then today's post is for you.
...
If you still find it a bit confusing about Flutter StatefulWidget, do [reach out to me](/contact) on [Twitter](https://twitter.com/tryshameem) or add your comment in the comment box below.
