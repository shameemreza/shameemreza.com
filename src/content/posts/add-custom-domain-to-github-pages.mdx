...
description: "How to Add Custom Domain to GitHub Pages?"
...
- A GitHub account.
- A repository for your GitHub Pages [website](https://shameem.me/7-things-to-prepare-when-designing-a-new-website/).
- A custom domain purchased from a [domain provider](https://shameem.me/13-best-domain-registrars-of-2021/).
...
[![](/uploads/custom-domain-github-1024x613.png)](https://shameem.me/add-custom-domain-to-github-pages/custom-domain-github/)
...
Here are specific guides for adding a custom domain to your GitHub Pages website for some [popular domain providers](https://shameem.me/13-best-domain-registrars-of-2021/):
