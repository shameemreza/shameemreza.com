...
Whether on your CV or your online profile (Linkedin, Github, Portfolio, Personal [website](https://shameem.me/buy-website-hosting-using-siteground/)…), you will make the difference by having relevant, clear and effective content (and a not too ugly design 😄). The main points are:

## A Specific Job Objective


Make a choice and write it down clearly at the top of your CV: Are you aiming for a “Fullstack Developer”, “Backend Developer”, “Frontend Developer”, "[iOS App Developer](https://shameem.me)" position? On "JavaScript", "Java", "Python", "PHP", "Swift", "SwiftUi" etc?
...
If you are looking for a position on the front, graphics, [UX-UI design](https://shameem.me/common-ui-ux-design-mistakes-and-how-to-avoid/) ... the shape of your CV is obviously more important. Be careful not to overdo it: a CV is meant to inform and its design should not detract from it.
