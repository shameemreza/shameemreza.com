...
featuredImage: "/uploads/how-to-learn-flutter.jpg"
draft: false
---
...
You will learn how to create a [Flutter application](/how-to-get-user-current-location-in-flutter/) from scratch, using Firebase Firestore (a real-time database) and Firebase Authentication. This playlist is for developers who already know Flutter.
...
A YouTube channel dedicated to Flutter. You will discover many [tutorials on Flutter](/understanding-functions-in-dart-with-example/) like Firebase, UI, architecture, etc. There are also mobile and web lessons from Flutter.
