---
title: "Top List of Useful and Handy jQuery Plugin"
date: 2018-06-12T18:25:46Z
description: "A categorized list of jQuery plugins for carousels, animations, form elements, lightboxes, sliders, layout grids, parallax scrolling, and more."
category: "Development"
categorySlug: "development"
featuredImage: "/uploads/top-essential-jquery-plugin.jpg"
draft: false
---

jQuery Plugin is lightweight and very easy to use. Using just a few Kb file, you can create an awesome block in your projects.

According to BuiltWith currently used by over 78% of top million sites using jQuery. It is very lightweight, and extendable, thats why there are plenty of jQuery plugins freely available for almost every functionality you can think of.



Just to help you find exactly what jQuery Plugin you are looking quickly, I made a top list of essential and handy jQuery plugins list.

> Few days ago, I wrote a top list paid traffic sources for marketer. Some of students and programmer friends ask me to make an useful list for them. And thats why this post come in my mind.



## ![](/uploads/17923684105b200bcbbf5553.89852968-shutterstock-1030144540.png)



## Top Essential jQuery Plugin list 2018
...
- [Owl Carousel](http://owlgraphic.com/owlcarousel/): A fantastic carousel plugin you can use in your responsive projects. One of the most popuar jQuery plugin to make carousel slider.
...
- [Transit](http://ricostacruz.com/jquery.transit/): CSS3 Transition and Animation Library you can use in your any projects.
...
- [Tilt.js](https://github.com/gijsroge/tilt.js): A tiny 60+fps parallax tilt hover effect for jQuery. I personally like it.
...
- [BlurJS](http://blurjs.com/): A jQuery plugin that produces psuedo-transparent blurred elements over other elements
...
- [LookingFor](https://github.com/albburtsev/jquery.lookingfor): jquery.lookingfor plugin searches text in list items (\<li\>) and hides unmatched items. It works for \<li\>and any HTML element on a page. Any input field (input, textarea) can be transformed to search filter with jquery.lookingfor
...
- [PrettyPhoto](http://www.no-margin-for-errors.com/projects/prettyphoto-jquery-lightbox-clone/): PrettyPhoto is a jQuery lightbox clone. It support images, videos, flash, YouTube, iframes and ajax. It’s a full blown media lightbox.
...
- [NanoScroller.js](http://jamesflorentino.github.io/nanoScrollerJS/): This jQuery plugin offers a simplistic way of implementing Mac OS X Lion-styled scrollbars for your website.
- [NiceScroll](http://areaaperta.com/nicescroll/): Thisjquery plugin usefor nice scrollbars with a very similar ios/mobile style.
...
- [jQuery Tweetable](https://github.com/jmduke/jquery.tweetable.js): A simple plugin that lets you make site content easily tweetable.
...
- [jQuery Bootgrid](http://www.jquery-bootgrid.com/): Nice, sleek and intuitive grid control system especially designed for bootstrap.
...
- [Toolbar.js](http://paulkinzett.github.io/toolbar/): A jQuery plugin that creates tooltip style toolbars in awesome way.
...
- [Treed](https://github.com/jaredly/treed): A powerful tree editing component. Treed wants to be for tree editing what ace is for text editing. Extensible, customizible, powerful, and just plain easy to use.
...
- [SirTrevor](http://madebymany.github.io/sir-trevor-js/): A really very beautiful and rich content editor re-imagined for web.
...
- [jQuery.Vibrate](https://github.com/illyism/jquery.vibrate.js): This plugin allows developers to vibrate a device (in a pattern) for a given duration. A very handy and useful plugin.


Hope this list will help you a lot. If I left any plugin to add in my list, please let me know via comment box.
