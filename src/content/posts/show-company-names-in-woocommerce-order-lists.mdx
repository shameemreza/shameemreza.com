...
description: "WooCommerce shows customer names in the order list by default. For B2B stores, this snippet replaces it with the billing company name using a simple filter."
category: "WordPress"
