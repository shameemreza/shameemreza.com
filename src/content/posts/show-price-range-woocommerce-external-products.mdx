...
featuredImage: "../../assets/uploads/show-price-range-woocommerce-external-products.jpg"
draft: false
---
...
![Price range field in the WooCommerce product data panel](../../assets/uploads/woocommerce-external-product-price-range-field.png)
...
![External product page without a price](../../assets/uploads/woocommerce-external-product-price-range-before.png)

After filling in the field, the range sits exactly where a price normally would:

![External product page showing the price range](../../assets/uploads/woocommerce-external-product-price-range-after.png)
