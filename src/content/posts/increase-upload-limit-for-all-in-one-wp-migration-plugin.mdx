...
description: "The 512 MB upload limit in All-in-One WP Migration isn't a server setting. It's a JavaScript check. Here's what actually stops large imports and how to raise the limit for free, without editing constants.php."
category: "WordPress"
categorySlug: "wordpress"
featuredImage: "../../assets/uploads/increase-upload-limit-for-all-in-one-wp-migration-plugin.jpg"
draft: false
---
...
![All-in-One WP Migration export options](../../assets/uploads/export-options.png)
...
![All-in-One WP Migration import page showing Unlimited upload size after installing the plugin](../../assets/uploads/preview-1024x366.png)
...
![File manager with show hidden files enabled in cPanel](../../assets/uploads/show-hidden-files.png)

Then you edit the `.htaccess` file and add the config at the bottom.

![Editing .htaccess file in the file manager](../../assets/uploads/edit-htaccess.png)
