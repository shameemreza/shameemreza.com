...
description: "Flutter's hot reload preserves app state while reflecting code changes instantly. Here's how to trigger it in VS Code, Android Studio, and the terminal."
...
Do you want to know how to use hot reload and hot restart provided by Flutter SDK? Today we will learn about these awesome features available in Flutter.

Before starting, let's learn what is Hot Reload and Hot Restart? Also, why it's important for Mobile Apps Developer?
...
The screenshot below shows the console output when a hot reload is triggered by saving files in Android Studio.

[![Hot reload output](/uploads/flutter-hot-reload.jpg)](/how-to-use-hot-reload-and-hot-restart-in-flutter/flutter-hot-reload/)
...
Posts on Hot Reload and Hot Restart in Flutter are usually very technical, but I found it difficult to understand many concepts by just reading the Flutter official [documentation](https://docs.flutter.dev/tools/hot-reload), so, since I got a better hang of it, why not share on my blog?
